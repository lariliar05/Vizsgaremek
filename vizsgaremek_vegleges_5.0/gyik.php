...
<div style="padding:20px;">
  ...
  <div class="faq" id="faqList">
    ...
    <details>
     ...
     <details>
    <summary>Hogyan tudok szervezetként regisztrálni?</summary>
    <div class="answer">
      A regisztrációs oldalon pipáld be a <b>„Szervezetként regisztrálok”</b> jelölőt, és add meg a <b>szervezet nevét</b>.
      A rendszer a fiókodat szervezeti felhasználóként jelöli (<code>is_org = 1</code>).
    </div>
  </details>

  <details>
    <summary>Hol találom a „Szervezetként regisztrálok” kapcsolót?</summary>
    <div class="answer">
      A regisztrációs űrlap alján. Pipálás után megjelenik a <b>Szervezet neve</b> mező.
      Közvetlen link: <code>regisztracio.php?org=1</code> (így már bepipálva nyílik meg).
    </div>
  </details>

  <details>
    <summary>Honnan tudom, hogy szervezetként vagyok bejelentkezve?</summary>
    <div class="answer">
      A fiókodhoz <b>is_org</b> jelző tartozik. Bejelentkezés után ennek megfelelően engedélyezett a
      <b>szervezeti adomány</b> funkció. Szükség esetén support/admin átállítja.
    </div>
  </details>

  <!-- INGYEN KÖNYVEK – SZERVEZETI ADOMÁNY -->
  <details>
    <summary>Mi az a „Szervezeti adomány” az ingyen könyveknél?</summary>
    <div class="answer">
      Felajánláskor megjelölhető, hogy a könyv <b>csak szervezeteknek</b> legyen elvihető.
      Ilyenkor magánszemély nem tudja igényelni.
    </div>
  </details>

  <details>
    <summary>Mit jelent a „Cél: kijelölt szervezet” felirat?</summary>
    <div class="answer">
      A feladó megadott egy <b>konkrét cél szervezetet</b>. Ilyenkor kizárólag az a szervezet igényelheti az adományt.
    </div>
  </details>

  <details>
    <summary>Miért nem tudom elvinni a könyvet?</summary>
    <div class="answer">
      Gyakori okok:
      <ul>
        <li><b>Nem vagy bejelentkezve</b>.</li>
        <li><b>Magánszemélyként</b> próbálod (szervezeti adományhoz szervezeti fiók kell).</li>
        <li><b>Kijelölt szervezetnek</b> szól, és nem a te szervezeted az.</li>
        <li>A felajánlás már <b>nem elérhető</b>.</li>
      </ul>
    </div>
  </details>

  <details>
    <summary>Hogyan adhatok fel „Szervezeti adományt”?</summary>
    <div class="answer">
      Az <b>Ingyen könyv felajánlása</b> űrlapon pipáld be a <b>Szervezeti adomány</b>-t, és (opcionálisan)
      válassz <b>Cél szervezetet</b>. Mentés után jelvényekkel jelenik meg.
    </div>
  </details>

  <!-- ESEMÉNYEK MODUL -->
  <details>
    <summary>Hol látom az eseményeket?</summary>
    <div class="answer">
      A menüben az <b>Események</b> oldalon. A lista automatikusan frissül, és mindig a legközelebbi
      <b>6</b> jövőbeli eseményt mutatja.
    </div>
  </details>

  <details>
    <summary>Milyen gyakran frissül a lista?</summary>
    <div class="answer">
      <b>60 másodpercenként</b>. A háttér-logika gondoskodik róla, hogy mindig legyenek közeli időpontok.
    </div>
  </details>

  <details>
    <summary>Hogyan tudok jelentkezni / visszamondani?</summary>
    <div class="answer">
      Kattints az esemény kártyáján a <b>Jelentkezem</b> vagy <b>Visszamondom</b> gombra.
      Be kell jelentkezned. A rendszer figyeli a <b>kapacitást</b> és az <b>időpontot</b>.
    </div>
  </details>

  <details>
    <summary>Miért írja, hogy „Telt ház” vagy nem enged jelentkezni?</summary>
    <div class="answer">
      Ha a regisztráltak száma elérte a <b>kapacitást</b>, a gomb letiltott. Már elkezdett eseményre
      nem lehet jelentkezni. Jelentkezéshez bejelentkezés kell.
    </div>
  </details>

  <details>
    <summary>Miért csak 6 eseményt látok?</summary>
    <div class="answer">
      Az oldal a <b>legközelebbi 6</b> jövőbeli eseményt emeli ki az áttekinthetőség érdekében.
    </div>
  </details>
</section>
