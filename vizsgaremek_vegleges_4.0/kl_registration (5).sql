...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Sze 07. 11:47
...
(31, 'Vizsgaremek01', 'remekvizsga01@gmail.com', 'd84ebdde1677c42785f2bf86f110bb40', '', '', '2025-09-07 11:30:26', '', '', 'a', '');
...
--
ALTER TABLE `login`
  MODIFY `logid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT a táblához `naplo`
--
ALTER TABLE `naplo`
  MODIFY `nid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3334;
